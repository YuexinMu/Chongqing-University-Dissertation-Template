...
% ===================
  cauthor = \secretize{穆跃鑫},	% 你的姓名，以下每项都以英文逗号结束
  eauthor = \secretize{Yuexin~Mu},	% 姓名拼音，~代表不会断行的空格
  studentid = \secretize{},	% 仅本科生，学号
  csupervisor = \secretize{刘~~~铎~~~~~教授},	% 导师的姓名
  esupervisor = \secretize{{Prof.~Duo Liu}},	% 导师的姓名拼音
  ...
  cclass = \secretize{\rmfamily{2026}\heiti{年}\rmfamily{6}\heiti{月}},	% 博士生和学硕填学科门类，学硕填学科类型
